...
README="""
## Description
Implementing SAML on FastAPI using Keycloak & python3-saml with less than 100 lines-of-code
...
- API documentation is on [http://127.0.0.1:3000/docs](http://127.0.0.1:3000/docs)
"""
