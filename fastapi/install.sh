...
do
  case $opt in
    ...
    "Install Latest")
      ...
      pip install aiofiles fastapi uvicorn[standard] python-multipart SQLAlchemy passlib[bcrypt] python-jose[cryptography] boto3 pymongo redis huey graphene requests
